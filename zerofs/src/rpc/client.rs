...
impl RpcClient {
    ...
    pub async fn get_lease_status(&self, path: &str) -> Result<proto::GetLeaseStatusResponse> {
        let request = proto::GetLeaseStatusRequest {
            path: path.to_string(),
        };
    ...
    pub async fn acquire_lease(&self, path: &str) -> Result<proto::AcquireLeaseResponse> {
        let request = proto::AcquireLeaseRequest {
            path: path.to_string(),
        };
    ...
    pub async fn prepare_handoff(&self, path: &str) -> Result<proto::PrepareHandoffResponse> {
        let request = proto::PrepareHandoffRequest {
            path: path.to_string(),
        };
    ...
    pub async fn complete_handoff(&self, path: &str) -> Result<proto::CompleteHandoffResponse> {
        let request = proto::CompleteHandoffRequest {
            path: path.to_string(),
        };
    ...
    pub async fn list_held_leases(&self) -> Result<proto::ListHeldLeasesResponse> {
        let request = proto::ListHeldLeasesRequest {};

        let response = self
            .client
            .clone()
            .list_held_leases(request)
            .await
            .map_err(|s| anyhow!("{}", s.message()))?
            .into_inner();
